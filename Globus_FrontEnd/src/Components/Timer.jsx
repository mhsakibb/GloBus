...
const Timer = () => {
  ...
  return (
    <>
      <div className="oswald text-4xl font-bold text-gray-900 dark:text-gray-100 flex text-center justify-center mt-5">
        <h1 className="text-gray-900 dark:text-gray-100">Monthly Deals</h1>
      </div>

      <div className="text-center bg-red-600 text-white font-bold mt-5 p-3 rounded-lg w-80 mx-auto flex justify-around shadow-md">
        <div className="bg-white dark:bg-gray-800 text-red-600 dark:text-red-400 rounded-lg px-3 py-2 flex flex-col items-center w-14">
