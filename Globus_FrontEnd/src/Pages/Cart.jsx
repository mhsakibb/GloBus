      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-8 gap-4">
          <div className="flex items-center gap-4">
            <button
              onClick={continueShopping}
              className="flex items-center gap-3 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:text-gray-200 transition-all duration-300 bg-white dark:bg-gray-800 px-4 py-3 rounded-2xl shadow-sm hover:shadow-md border border-gray-200 dark:border-gray-700"
            >
              <FontAwesomeIcon icon={faArrowLeft} />
              <span className="font-medium">Continue Shopping</span>
            </button>
            <div className="min-h-[80px] flex items-center">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-200 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text ">
                Shopping Cart
              </h1>
            </div>
          </div>
          <button
            onClick={clearCart}
            className="text-red-500 hover:text-red-700 transition font-medium bg-white dark:bg-gray-800 px-4 py-2 rounded-xl border border-red-200 hover:border-red-300"
          >
            Clear Entire Cart
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-4 sm:p-6 border border-gray-100 dark:border-gray-700">
              {/* Header - Adjusted grid columns */}
              <div className="grid grid-cols-12 gap-2 sm:gap-3 text-sm font-semibold text-gray-600 dark:text-gray-400 pb-4 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="divide-y divide-gray-100">
                {cartItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item._id}
                      className="py-4 sm:py-6 group hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 rounded-lg px-1"
                    >
                      ...
                      <div className="grid grid-cols-12 gap-2 sm:gap-3 items-center">
                        ...
                        <div className="col-span-5 flex items-center gap-2 sm:gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-gray-800 dark:text-gray-200 text-sm sm:text-base mb-1 line-clamp-2 leading-tight">
                        ...
                        <div className="col-span-3">
                          <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                            <button
                              ...
                              className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700 hover:border-gray-400 transition-all duration-200 shadow-sm"
                            >
                              <FontAwesomeIcon
                                icon={faMinus}
                            ...
                            <span className="font-bold text-gray-800 dark:text-gray-200 text-sm sm:text-base min-w-6 text-center bg-gray-50 dark:bg-gray-800 dark:bg-gray-900 py-1 px-2 rounded-lg border border-gray-200 dark:border-gray-700">
                              {item.quantity || 1}
                            </span>
                            <button
                              onClick={() =>
                        ...
                        <div className="col-span-2 flex flex-col items-center gap-1 sm:gap-2">
                          <span className="font-bold text-gray-800 dark:text-gray-200 text-sm sm:text-base text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-white dark:from-gray-800 to-gray-50 dark:to-gray-900 rounded-2xl p-4 sm:p-6 text-center border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-4 sm:p-6 sticky top-6 border border-gray-100 dark:border-gray-700">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4 sm:mb-6 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text ">
                Order Summary
              </h3>
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-3 sm:pt-4">
                  <div className="flex justify-between text-lg sm:text-xl font-bold text-gray-800 dark:text-gray-200">
                    <span>Total</span>
                  ...
                  {shipping === 0 && (
                    <p className="text-green-600 text-xs sm:text-sm mt-2 text-right">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all text-sm sm:text-base"
                  />
                  <button
              ...
              {/* Security Message */}
              <div className="text-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-800 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200">
                ...
                <p className="text-xs sm:text-sm text-blue-600">
                  2-4 business days • Free returns
                </p>
              </div>
            </div>
          </div>
