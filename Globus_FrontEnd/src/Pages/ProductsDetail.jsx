...
const ProductsDetail = () => {
  ...
  const handleAddToCart = () => {
    alert(
      `Added ${quantity} of ${productData.name}${
        selectedVariant
  ...
  if (!productData)
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50 dark:bg-gray-800 dark:bg-gray-900">
  ...
  const discountPercentage = productData.discountPrice
    ? Math.round(
        ((productData.price - productData.discountPrice) / productData.price) *
          100,
      )
    : 0;

  return (
    <div className="max-w-7xl mx-auto p-4 bg-white dark:bg-gray-800 min-h-screen">
      {/* Breadcrumb */}
              ...
              <div className="flex lg:flex-col gap-2 order-2 lg:order-1">
                {productData.images?.map((img, idx) => (
                  <img
                    ...
                    src={img}
                    alt={`thumbnail-${idx}`}
                    className={`w-16 h-16 lg:w-20 lg:h-20 object-cover rounded-lg cursor-pointer border-2 transition-all ${
                      selectedImage === img
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-4 mb-6">
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                ৳
                {productData.flashSale?.isActive
                  ? productData.flashSale.flashPrice
            ...
            {/* Stock Status */}
            <div
              className={`inline-flex items-center px-3 py-2 rounded-full text-sm font-medium mb-6 ${
                productData.stock > 0
            ...
            >
              <span
                className={`w-2 h-2 rounded-full mr-2 ${productData.stock > 0 ? "bg-green-500" : "bg-red-500"}`}
              ></span>
              {productData.stock > 0
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center border border-gray-300 rounded-lg">
                  ...
                  <button
                    onClick={() =>
                      quantity <
                        (selectedVariant?.stock || productData.stock) &&
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span className="font-medium">
                    {productData.specifications.weight || "N/A"}
                  </span>
                </div>
                <div className="flex justify-between border-b pb-2">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium">
                    {productData.specifications.dimensions || "N/A"}
                  </span>
                </div>
                <div className="flex justify-between border-b pb-2">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium">
                    {productData.specifications.origin || "N/A"}
                  </span>
                </div>
                <div className="flex justify-between border-b pb-2">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium">
                    {productData.specifications.washable || "N/A"}
                  </span>
                </div>
              </div>
            </div>
          ...
          {activeTab === "shipping" && productData.shipping && (
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 dark:bg-gray-800 dark:bg-gray-900 p-4 rounded-lg">
              ...
              {productData.faq?.length > 0 ? (
                <div className="space-y-4">
                  {productData.faq.map((item, idx) => (
                    ...
                    >
                      <div className="p-4 bg-gray-50 dark:bg-gray-800 dark:bg-gray-900">
        ...
        {loadingRelated ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedProducts.map((product) => (
              <div
                key={product._id}
                className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 cursor-pointer"
                      ...
                      <div className="flex items-center gap-1">
                        <div className="flex text-yellow-400">
                          {[...Array(5)].map((_, i) => (
                            <svg
                              key={i}
                              className={`w-3 h-3 ${i < Math.floor(product.ratings.average || 0) ? "fill-current" : "text-gray-300"}`}
                              viewBox="0 0 20 20"
                            >
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
