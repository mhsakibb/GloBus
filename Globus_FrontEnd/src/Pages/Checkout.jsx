          ...
          <div className="flex items-center justify-center">
            {[1, 2, 3].map((step) => (
              <div key={step} className="flex items-center">
                <div
                  className={`flex flex-col items-center ${step <= activeStep ? "text-orange-500" : "text-gray-400"}`}
                >
                  <div
                ...
                {step < 3 && (
                  <div
                    className={`w-24 h-1 mx-4 ${step < activeStep ? "bg-orange-500" : "bg-gray-300"}`}
                  ></div>
                )}
              </div>
            ))}
                ...
                <form onSubmit={handleShippingSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    {cartItems.map((item) => (
                      <div
                        key={item._id}
                        className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl"
                      >
                        <img
                          src={
                            item.productImage ||
              ...
              <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                ...
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">
                    SSL Commerz Secure Payment
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    You will be redirected to SSL Commerz secure payment gateway
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 sticky top-6 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-4 mb-6 max-h-96 overflow-y-auto">
                {cartItems.map((item) => (
                  <div
                    key={item._id}
                    className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 dark:bg-gray-900 rounded-xl"
                  >
                    <img
                      src={
                        item.productImage ||
                ...
                <div className="mt-6">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all text-sm"
                    />
                    <button
